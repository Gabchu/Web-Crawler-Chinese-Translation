...
class ZhConversion
{
  ...
  {
    $json = json_encode(self::$zh2Hant, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE);
    file_put_contents('zh2Hant.json', $json);
  }
}

// Call the exportToJson method to export the data
ZhConversion::exportToJson();
